...
void to_json(nlohmann::json& j, const AssetData& obj)
{
    ...
    if (obj.cyclopean3dData)
    {
        j["cyclopean3d"] = *obj.cyclopean3dData;
    }
    if (obj.stone3dData)
    {
        j["stone3d"] = *obj.stone3dData;
    }
    if (obj.texture2dData)
    {
    ...
    if (obj.mask3dData)
    {
        j["mask3d"] = *obj.mask3dData;
    }
    if (obj.fence3dData)
    {
        j["fence3d"] = *obj.fence3dData;
    }
    if (obj.building3dData)
    {
        j["building3d"] = *obj.building3dData;
    }
}
...
void from_json(const nlohmann::json& j, AssetData& obj)
{
    ...
    if (j.contains("cyclopean3d"))
    {
        obj.cyclopean3dData = j["cyclopean3d"].get<Cyclopean3dAssetData>();
    }
    if (j.contains("stone3d"))
    {
        obj.stone3dData = j["stone3d"].get<Stone3dAssetData>();
    }
    ...
    if (j.contains("mask3d"))
    {
        obj.mask3dData = j["mask3d"].get<Mask3dAssetData>();
    }
    if (j.contains("fence3d"))
    {
        obj.fence3dData = j["fence3d"].get<Fence3dAssetData>();
    }
    if (j.contains("building3d"))
    {
        obj.building3dData = j["building3d"].get<Building3dAssetData>();
    }
}
