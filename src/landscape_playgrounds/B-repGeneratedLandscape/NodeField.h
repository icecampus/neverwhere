...
// grid (0/1) with a monotonic content version — the same vertex-centric
// contract the editor's LandscapeModel and the SDF playgrounds' LandBrush
// expose, reduced to the minimum the B-rep pipeline needs.
struct NodeField {
