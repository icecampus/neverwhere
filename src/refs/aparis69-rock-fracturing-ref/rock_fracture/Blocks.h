...
public:
    ...
    inline Vector3 At(int i) const { return pts[i]; }
    inline Vector3& At(int i) { return pts[i]; }
    inline int Size() const { return int(pts.size()); }
};
...
public:
    ...
    inline Circle At(int i) const { return fractures[i]; }
    inline Circle& At(int i) { return fractures[i]; }
    inline int Size() const { return int(fractures.size()); }
};
