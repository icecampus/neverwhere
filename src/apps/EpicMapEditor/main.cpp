...
void registreTypes()
{
    ...
    qmlRegisterType<CliffAsset>("Game", 1, 0, "CliffAsset");
    qmlRegisterType<CyclopeanAsset>("Game", 1, 0, "CyclopeanAsset");
    ...
    qmlRegisterType<FenceAsset>("Game", 1, 0, "FenceAsset");
    qmlRegisterType<Building3dAsset>("Game", 1, 0, "Building3dAsset");
