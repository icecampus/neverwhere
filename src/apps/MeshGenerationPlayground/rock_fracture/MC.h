/*
 Port of MC.h (Marching Cubes) - https://github.com/aparis69/MarchingCubeCpp
 Original by Axel Paris, 2020. Adapted to namespace rock_fracture/MC.
*/

#ifndef ROCK_FRACTURE_MC_INCLUDED
#define ROCK_FRACTURE_MC_INCLUDED
...
#endif /* ROCK_FRACTURE_MC_INCLUDED */
