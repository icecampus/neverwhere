...
def main() -> int:
    ap = argparse.ArgumentParser(description="Generate material atlas (Ridge variant).")
    ap.add_argument("output", nargs="?", default="atlas_ridge_material.png", help="Output PNG path.")
