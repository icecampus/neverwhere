...
def generate_png_atlas():
    ...
    # RIDGE / HYBRID (CURRENT) VARIANT
    # Corners: Peak (Center 0.5)
    # Opposites: Saddle (Center 0.5)
    # Lacks: Folded (Center 0.5)
    ...
    masks = {
        ...
        # RIDGE SPECIFIC: Center 0.5 for Corners
        ...
        # RIDGE/HYBRID SPECIFIC: Center 0.5 for Opposites
    ...
    for i in range(COLS * ROWS):
        ...
        if any(h > 0 for h in heights) or t_type == 'Unknown':
            ...
            # TRIANGULATION LOGIC (RIDGE/HYBRID)
            # Use Fan logic (4 triangles) for anything non-flat to support Center 0.5
            if t_type in ['UpAndDownCorners', 'LeftRightCorners', 
                          'UpCorner', 'DownCorner', 'LeftCorner', 'RightCorner',
                          'UpLack', 'DownLack', 'LeftLack', 'RightLack']:
                tris = [(4, 0, 1), (4, 1, 2), (4, 2, 3), (4, 3, 0)]
            else:
                 # Default Split Up-Down (Full, Lines)
                 tris = [(0, 1, 3), (1, 2, 3)]
