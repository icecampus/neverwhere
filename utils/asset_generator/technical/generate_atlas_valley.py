...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Technical atlas generator (Valley/Concave). Writes temp output and publishes to resources.")
    ...
    if args.output:
        ...
        out_dir = os.path.join(args.temp_root, "technical", "valley", run_id)
        ensure_dir(out_dir)
    ...
    if not args.no_publish:
        publish_atlas_and_thumbnail(
            ...
            pack_dir=os.path.join("resources", "assets", "landscape", "TechnicalGrassValley"),
            cols=4,
            rows=6,
            thumb_width=args.thumb_width,
            ensure_index=False,
        )
        print("Published to resources/assets/landscape/TechnicalGrassValley (atlas.png + thumbnail.png)")
