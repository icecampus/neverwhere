...
| Playground'ы (визуальная проверка) | `src/apps/Landscape3dPlayground/`, `src/landscape_playgrounds/PolygonalGeneratedLandscape/` |
...
offscreen-production-preview путь, что и `PolygonalGeneratedLandscape`.
